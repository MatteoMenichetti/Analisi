...
\begin{example}[Funzione non integrabile secondo Riemann]\footnote{Slide 17 PDF 24}
	...
	\begin{equation*}
		\begin{cases}
			1, &\text{se } (x,y)\in Q\cap \mathbb{Q}\\
			0 &\text{altrimenti}
		\end{cases}
	\end{equation*}
