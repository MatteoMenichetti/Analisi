...
\begin{definition}[Sostegno di una curva]\footnote{Slide 6 PDF 15.}
	...
	\begin{equation*}
		\varepsilon(I)\subseteq\mathbb{R}^n,
	\end{equation*} 
...
\noindent Tornando alla Definizione di differenziabilità, se consideriamo $\uline h\rightarrow \uline0$, dunque $||\uline h||\rightarrow 0$ e
\begin{equation*}
...
\end{equation*}
per cui in quel punto non sarà differenziabile. 
