...
\begin{example}[Ricerca massimi e minimi vincolati]
	...
	\end{equation*}
	nel dominio $D=\{(x,y)\in\mathbb{R}^2\;|\; -1\leq x\leq 0,\; -1\leq y\leq x\}$.
	\paragraph{Svolgimento:} $f(x,y)$ è una funzione continua in $D$, quindi, per il Teorema \ref{th:weierstrass_2} di Weierstrass, ha minimo e massimo in $D$.
...
\begin{example}[Ricerca massimi e minimi vincolati]
	...
	\begin{equation*}
		f(x,y) = 1+x^2-y^2,
	\end{equation*}
	condizionati al vincolo $2x^2+y^2=2$.
	\paragraph{Svolgimento:}
\end{example}
