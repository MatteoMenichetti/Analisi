...
\begin{example}[Ricerca massimi e minimi vincolati]\label{ex:ottimizzazione_vincolata}\footnote{Adobe Scan 13 lug 2024.}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.5\textwidth]{Analisi2/figures/vincolo.jpg}\label{fig:vincolo}
		\caption{Grafico di $D=\{(x,y)\in\mathbb{R}^2\;|\; -1\leq x\leq 0,\; -1\leq y\leq x\}$.}
	\end{figure}
...
\begin{example}\label{ex:ottimizzazione_vincolata_1}\footnote{Compito12gennaio2024.}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.5\textwidth]{Analisi2/figures/vincolo_3}\label{fig:vincolo_3}
...
\begin{example}[Ricerca massimi e minimi vincolati]\label{ex:applicazione_metodo_lagrange}\footnote{Scritto 15 Settembre 2025.}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.5\textwidth]{Analisi2/figures/condizione_scritto_15_settembre}\label{fig:vincolo_2}
...
\begin{example}[Esempio di applicazione del Meteodo di Lagrange]
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.5\textwidth]{Analisi2/figures/vincolo_metodo_lagrange.jpg}\label{fig:vincolo_metodo_lagrange}
	\end{figure}
