...
\begin{example}[Ricerca massimi e minimi vincolati]\label{ex:applicazione_metodo_lagrange}\footnote{Scritto 15 Settembre 2025.}
	...
	\begin{itemize}
		...
		\begin{figure}[ht]
			\centering
			\includegraphics[width=0.35\textwidth]{Analisi2/figures/segno_derivata.jpg}\label{fig:f'_vincolata>0}
		\end{figure}
		...
		\begin{figure}[ht]
			\centering
			\includegraphics[width=0.35\textwidth]{Analisi2/figures/segno_derivata_1.jpg}\label{fig:f'_vincolata_1>0}
		\end{figure}
	\end{itemize}
...
\begin{example}[Esempio di applicazione del Meteodo di Lagrange]
	...
	\begin{figure}[ht]
		...
		\caption{Grafico di $x^2+y^2=1$ con massimo assoluto $(-1,0)$ e minimi assoluti $(\frac{1}{2}, \pm\frac{\sqrt{3}}{2})$.}
