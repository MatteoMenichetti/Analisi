...
\begin{example}[Ricerca massimi e minimi vincolati]\footnote{Scritto 15 Settembre 2025.}
	...
	\begin{itemize}
		\item [$D_1$] $f_{|_{D_1}} = f(x, \sqrt{2-2x^2}) = 1+ x^2 - (\sqrt{2-2x^2})^2 = 1+x^2-2+2x^2=3x^2-1$, quindi dallo studio del segno di $f'_{|_{D_1}}$ ($f'_{|_{D_1}} = 6x\geq0$? Vedere Figura \ref{fig:f'_vincolata>0}) è ottenuto che $(0,\sqrt{2})$ minimo assoluto e $(\pm 1, 1)$ massimi assoluti di $f_{|_{D_1}}$ in $[-1,1]$.
		\item [$D_2$] $f_{|_{D_2}}=f(\sqrt{\frac{2-y^2}{2}}, y) = 1+ \left(\sqrt{\frac{2-y^2}{2}}\right)^2 - y^2 = 1 + \sqrt{\frac{2-y^2}{2}} -y^2 = 2-\frac{3}{2} y^2$, quindi dallo studio del segno di $f'_{|_{D_2}}$ ($f'_{|_{D_2}} = -3y^2\geq0$? Vedere Figura \ref{fig:f'_vincolata_1>0}) è ottenuto che $(1,0)$ è il massimo assoluto e $(1, \pm\sqrt{2})$ i minimi assoluti di $f_{|_{D_2}}$ in $[-\sqrt{2}, \sqrt{2}]$.
	\end{itemize}
