...
\begin{equation*}
	f(x,y) = f(x_0,y_0) <\triangledown f(x_0,y_0), \uline h> + \frac{1}{2}<Hf(x_0,y_0)\uline h, \uline h> + o((x-x_0)^2-(y-y_0)^2)\quad\text{per } \uline h\rightarrow(0,0),
\end{equation*}
...
\begin{equation*}
	f(x,y) = P_2(x_0,y_0) + o(\underbrace{(x-x_0)^2-(y-y_0)^2}_{d^2(P,P_0)=||P-P_0||^2}).
\end{equation*}
