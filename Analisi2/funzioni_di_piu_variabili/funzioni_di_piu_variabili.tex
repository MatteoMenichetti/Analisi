...
\begin{example}\footnote{Slide 5 PDF 13.}
	...
	\end{equation*}
	\addtocounter{footnote}{-1}
	\footnotetext{È necessario far vedere che esiste una funzione radiale. Per ipotesi $|\cos\theta\sin\theta|=|\frac{1}{2}\sin\theta|\leq\frac{1}{2}$ e $|\sin\theta|\leq 1$, quindi è trovata la funzione radiale infinitesima $g(\rho)=\rho^2+\rho$ che permette di applicare il teorema del confronto e che il limite sia uniforme rispetto a $\theta$.}
...
\begin{example}\footnote{Slide 11 PDF 13.}
	...
	\end{equation*}
	per la quale l'idea è tenda a 0. \footnotetext{Pensando in coordinate polari, il denominatore va a 0 come $\rho^3$, ma il grado del nominatore è maggiore del grado del denominatore.}
