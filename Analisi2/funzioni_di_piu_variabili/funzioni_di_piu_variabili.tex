...
\begin{definition}[Dominio]\label{def:dominio}\footnote{Slide 4 PDF 9.}
...
\begin{figure}
    ...
    \begin{tikzpicture}[
    	...
    	% Assi cartesiani
    	\draw[thick,->] (-0.25,0) -- (4.10,0) node[right] {$x$};
    	\draw[thick,->] (0,-0.35) -- (0,3.15) node[above] {$y$};
    	
    	% Punto P e sue coordinate cartesiane
    	\coordinate (P) at (2.65,2.15);
    	\draw[very thick,->] (0,0) -- (P);
    	\draw[thick,dashed] (P) -- (2.65,0);
    	\draw[thick,dashed] (P) -- (0,2.15);
    	
    	% Angolo polare
    	\draw[thick,->] (0.62,0)
    	arc[start angle=0,end angle=39.1,radius=0.62];
    	
    	% Etichette
    	\node[font=\large] at (1.18,1.20) {$\rho$};
    	\node[font=\large] at (0.78,0.34) {$\theta$};
    	\node[font=\large,anchor=west] at (2.80,2.35)
    	{$P=(x_P,y_P)$};
    	\node[below=4pt] at (2.65,0) {$x_P$};
    	\node[left=5pt] at (0,2.15) {$y_P$};
    \end{tikzpicture}
...
\begin{figure}
   ...
   % \includegraphics[width=0.5\textwidth]{Analisi2/figures/piano_coordinate_polari_centrate_x0_y0.jpg}
    \begin{tikzpicture}[
    	...
    	% Assi cartesiani
    	\draw[thick,->] (-0.25,0) -- (4.65,0) node[right] {$x$};
    	\draw[thick,->] (0,-0.35) -- (0,3.75) node[above] {$y$};
    	
    	% Centro (x_0,y_0) e punto P=(x,y)
    	\coordinate (C) at (0.95,0.90);
    	\coordinate (P) at (3.35,2.95);
    	\draw[very thick,->] (C) -- (P);
    	
    	% Proiezioni tratteggiate
    	\draw[thick,dashed] (0,0.90) -- (3.35,0.90);
    	\draw[thick,dashed] (0,2.95) -- (3.35,2.95);
    	\draw[thick,dashed] (0.95,0) -- (0.95,2.95);
    	\draw[thick,dashed] (3.35,0) -- (3.35,2.95);
    	
    	% Angolo rispetto al centro traslato
    	\draw[thick,->] (1.58,0.90)
    	arc[start angle=0,end angle=40.5,radius=0.63];
    	
    	% Etichette
    	\node[font=\large] at (1.85,1.85) {$\rho$};
    	\node[font=\large] at (1.72,1.22) {$\theta$};
    	\node[font=\large,anchor=west] at (3.47,3.03) {$(x,y)=P$};
    	\node[below=4pt] at (0.95,0) {$x_0$};
    	\node[below=4pt] at (3.35,0) {$x$};
    	\node[left=5pt] at (0,0.90) {$y_0$};
    	\node[left=5pt] at (0,2.95) {$y$};
    \end{tikzpicture}
...
\paragraph{N.B.:} Data l'Osservazione precedente, per mostrare che vale il limite della funzione $f$ per $(x,y)\rightarrow (x_0,y_0)$ è applicato il Teorema \ref{th:dei_carabinieri_2} dei Carabinieri: si cerca di maggiorare la quantità $|f(x_0+\rho\cos\theta,y_0+\sin\theta)-\ell|<\varepsilon$ in (\ref{eq:limite_coordinate_polari}) con una funzione radiale. \footnote{Una funzione radiale è una funzione che dipende solo dal raggio $\rho$, è una maggiore uguale a 0 ed infinitesima (ovvero tende a 0 quando $\rho\rightarrow 0$)}.\\
...
\centering
    ...
    \begin{tikzpicture}[
    	...
    	% Assi cartesiani tridimensionali in proiezione obliqua
    	\coordinate (O) at (0,0);
    	\draw[very thick,->] (O) -- (-3.55,-3.55) node[below left] {$X$};
    	\draw[very thick,->] (O) -- (5.55,0) node[right] {$Y$};
    	
    	% Dominio di definizione nel piano (x,y)
    	\def\baseR{
    		(-0.78,-1.73)
    		.. controls (-0.16,-1.28) and (0.42,-1.22) .. (1.08,-1.52)
    		.. controls (1.74,-1.82) and (2.22,-1.65) .. (2.75,-1.28)
    		.. controls (3.35,-0.88) and (4.12,-0.63) .. (4.55,-0.97)
    		.. controls (4.86,-1.25) and (4.73,-2.02) .. (4.54,-2.57)
    		.. controls (4.30,-3.23) and (3.78,-3.47) .. (3.25,-3.18)
    		.. controls (2.72,-2.88) and (2.48,-3.02) .. (2.02,-3.25)
    		.. controls (1.51,-3.50) and (1.03,-3.20) .. (0.62,-2.77)
    		.. controls (0.18,-2.33) and (-0.48,-2.43) .. (-0.78,-1.73)
    		-- cycle
    	}
    	\draw[very thick] \baseR;
    	
    	% Superficie grafico z=f(x,y)
    	\def\surface{
    		(-1.62,2.86)
    		.. controls (-1.23,3.56) and (-0.38,3.76) .. (0.32,3.54)
    		.. controls (1.10,3.30) and (1.62,3.42) .. (2.20,3.78)
    		.. controls (2.84,4.19) and (3.68,4.17) .. (4.20,3.77)
    		.. controls (4.76,3.33) and (4.56,2.58) .. (4.20,2.10)
    		.. controls (3.83,1.62) and (3.12,1.49) .. (2.49,1.68)
    		.. controls (1.80,1.88) and (1.25,1.64) .. (0.63,1.84)
    		.. controls (-0.05,2.05) and (-0.63,1.70) .. (-1.15,1.88)
    		.. controls (-1.73,2.08) and (-1.98,2.43) .. (-1.62,2.86)
    		-- cycle
    	}
    	\fill[white] \surface;
    	\begin{scope}
    		\clip \surface;
    		\foreach \s in {-2.5,-1.8,...,5.2}
    		\draw[black,thick] (\s,1.40) -- ({\s+1.75},4.45);
    	\end{scope}
    	\draw[black,very thick] \surface;
    	
    	% Porzione nascosta della superficie con tratteggio obliquo
    	\def\hiddenband{
    		(-0.78,1.82)
    		.. controls (-0.10,1.42) and (0.76,1.42) .. (1.48,1.65)
    		.. controls (1.05,1.74) and (0.61,1.88) .. (0.16,2.01)
    		.. controls (-0.25,2.10) and (-0.57,1.98) .. (-0.78,1.82)
    		-- cycle
    	}
    	\begin{scope}
    		\clip \hiddenband;
    		\foreach \s in {-1.40,-0.85,...,1.35}
    		\draw[black,thick] (\s,1.55) -- ({\s+0.18},1.87);
    	\end{scope}
    	\draw[black,very thick,densely dotted]
    	(-0.78,1.82)
    	.. controls (-0.10,1.42) and (0.76,1.42) .. (1.48,1.65);
    	
    	% Asse z: grigio soltanto nel tratto coperto dalla superficie
    	\draw[black,very thick] (O) -- (0,1.95);
    	\draw[gray!65,very thick] (0,1.95) -- (0,3.6);
    	\draw[black,very thick,->] (0,3.6) -- (0,4.55)
    	node[above] {$Z$};
    	% Punto del dominio, punto sul grafico e proiezioni
    	\coordinate (Q) at (2.72,-1.78);
    	\coordinate (P) at (2.72,2.74);
    	\fill (Q) circle[radius=2.4pt];
    	\fill (P) circle[radius=2.7pt];
    	\draw[thick,densely dashed] (Q) -- (P);
    	\draw[thick,densely dashed] (-1.78,-1.78) -- (Q);
    	\draw[thick,densely dashed] (Q) -- (4.35,-0.05);
    	\draw[thick,densely dashed] (0,2.74) -- (P);
    	% Piano (y,z) individuato da x=k
    	\draw[red,very thick]
    	(-1.78,4.05) -- (-1.78,2.06) -- (4.80,2.06) -- (4.80,3.72);
    	\node[red,font=\large,anchor=west,fill=white,inner sep=1pt]
    	at (-4.08,4.20) {piano $(y,z)$ con $x=k$};
    	
    	% Piano (x,y) individuato da z=k
    	\draw[red,very thick]
    	(3.62,4.48) -- (3.62,-2.70) -- (4.55,-2.70);
    	\draw[red,very thick] (3.62,4.48) -- (4.48,4.48);
    	\node[red,font=\large,anchor=west,fill=white,inner sep=1pt]
    	at (2.52,4.870) {piano $(x,y)$ con $z=k$};
    	
    	% Etichetta del punto in primo piano anche rispetto alle linee rosse
    	\node[font=\large,anchor=west,fill=white,inner sep=1pt]
    	at (2.84,2.78) {$P=(x,y,z)$};
    	\node[font=\large,anchor=west,fill=white,inner sep=1pt]
    	at (2.84,-1.82) {$(x,y)$};
    	\node[font=\Large,anchor=east,fill=white,inner sep=1pt]
    	at (-0.08,2.74) {$f(x,y)=z$};
    \end{tikzpicture}
...
\begin{figure}
    ...
    \begin{tikzpicture}[
    	...
    	% Assi cartesiani
    	\draw[very thick,->] (-0.25,0) -- (4.35,0)
    	node[below left=2pt] {$x$};
    	\draw[very thick,->] (0,-0.58) -- (0,4.05)
    	node[below right=2pt] {$y$};
    	
    	% Estremi dell'intervallo e altezze della funzione
    	\def\xa{1.12}
    	\def\xb{3.42}
    	\def\ya{1.08}
    	\def\yb{2.88}
    	
    	% Proiezioni verticali tratteggiate
    	...
    	\draw[very thick]
    	(\xa,\ya)
    	.. controls (1.72,0.92) and (2.22,1.10) .. (2.62,1.58)
    	.. controls (3.02,2.06) and (3.28,2.66) .. (\xb,\yb);
    	
    	% Etichette
    	\node[below=5pt] at (\xa,0) {$a$};
    	\node[below=5pt] at (\xb,0) {$b$};
    	\node[font=\large,anchor=west,fill=white,inner sep=1pt]
    	at (1.4,1.68) {$y=f(x)$};
    \end{tikzpicture}
...
\begin{figure}
	...
	\begin{tikzpicture}[
		...
		% Regione compresa tra il grafico e l'asse x
		\begin{scope}
			\clip
			(\xa,0) -- (\xa,\ya)
			.. controls (1.72,0.92) and (2.22,1.10) .. (2.62,1.58)
			.. controls (3.02,2.06) and (3.28,2.66) .. (\xb,\yb)
			-- (\xb,0) -- cycle;
			\foreach \s in {0.30,0.82,...,4.20}
			\draw[red!75,very thick]
			(\s,-0.55) -- ({\s+1.25},2.95);
		\end{scope}
		
		% Grafico e proiezioni degli estremi
		\draw[very thick,densely dotted] (\xa,0) -- (\xa,\ya);
		\draw[very thick,densely dotted] (\xb,0) -- (\xb,\yb);
		\draw[red!75,very thick] \graphpath;
...
\begin{figure}
	...
	\begin{tikzpicture}[
		...
		% Regione al di sopra del grafico
		\begin{scope}
			\clip
			\graphpath
			-- (\xb,3.92) -- (\xa,3.92) -- cycle;
			\foreach \s in {0.45,0.97,...,4.35}
			\draw[red!75,very thick]
			(\s,0.82) -- ({\s+1.15},4.05);
		\end{scope}
...
\begin{example}[Calcolo di derivate parziali]\footnote{Slide 6 PDF 14.}
    ...
    \begin{equation}\label{eq:derivate_parziali_metodo_normale}
        \begin{matrix}
            ...
            \frac{\partial f}{\partial y}(x,y)&=& -x\sin(x^2y^3)(3x^2y^2)+2x^6y&=&-3x^3y^2\sin(x^2y^3)+2x^6y.
        \end{matrix}
    \end{equation}
    ...
    \begin{equation*}
        \begin{matrix}
            ...
            \frac{\partial f}{\partial y}(1,2)&=&-3\cdot 1^3\cdot 2^2\sin(1^2\,2^3)+2\cdot1^6\cdot2 &=&-12\sin8+4.
        \end{matrix}
    \end{equation*}
...
\begin{definition}[Curva in $\mathbb{R}^n$]\footnote{Slide 5 PDF 15.}
	Una curva è un'applicazione continua ($\varphi\in C^0(I)$) definita come
	\begin{equation}\label{eq:curva}
		...
		\end{aligned}
	\end{equation}
	dove le $\varphi_i:I\rightarrow\mathbb{R}$ sono continue ($\varphi_i\in C^0(I)$ per ipotesi iniziale) $\forall i=1,\hdots,n$.
\end{definition}
...
\paragraph{Utilità equazioni parametriche:} Le equazioni parametriche descrivono il modo con il quale è determinata l'immmagine di $t$ attraverso $\varphi$ in $\mathbb{R}^n$, ovvero descrivono come cambia la funzione al variare del parametro $t$. Vedere le equazioni parametriche fisica.
...
\begin{figure}[ht]
	...
	\begin{tikzpicture}[
		...
		% Assi cartesiani
		\draw[thick,->] (-0.75,0) -- (4.65,0) node[right] {$x$};
		\draw[thick,->] (0,-0.35) -- (0,3.65) node[above] {$y$};
		
		% Ascisse e punto di tangenza
		\def\xa{1.20}
		\def\xzero{2.30}
		\def\xb{3.35}
		\def\yzero{1.75}
		
		% Grafico della funzione phi
		\draw[very thick]
		(\xa,0.82)
		.. controls (1.55,1.10) and (2.05,1.61) .. (\xzero,\yzero)
		.. controls (2.48,1.85) and (2.67,1.45) .. (2.92,1.60)
		.. controls (3.18,1.76) and (3.13,2.22) .. (\xb,2.62);
		\fill (\xb,2.62) circle[radius=2.3pt];
		\node[font=\large,above=4pt] at (\xb,2.62) {$\varphi$};
		
		% Retta tangente nel punto x_0
		\draw[blue,very thick]
		(0.42,0.72) -- (4.05,2.72);
		\node[blue,font=\large,anchor=west] at (4.07,2.72)
		{retta tangente};
		
		% Punto di tangenza e proiezioni sugli assi
		\fill[red] (\xzero,\yzero) circle[radius=2.3pt];
		\draw[red,thick,densely dotted]
		(0,\yzero) -- (\xzero,\yzero) -- (\xzero,0);
		\draw[black,thick,densely dotted] (\xa,0) -- (\xa,0.82);
		\draw[black,thick,densely dotted] (\xb,0) -- (\xb,2.62);
		
		% Etichette
		\node[red,font=\large,left=5pt] at (0,\yzero) {$y_0$};
		\node[below=4pt] at (\xa,0) {$a$};
		\node[red,font=\large,below=4pt] at (\xzero,0) {$x_0$};
		\node[below=4pt] at (\xb,0) {$b$};
		\node[red,font=\large,above=6pt,fill=white,inner sep=1.5pt]
		at (\xzero,\yzero)
		{$(x_0,\varphi(x_0))$};
	\end{tikzpicture}
...
\begin{figure}[ht]
	...
	% Figura: relazione tra derivabilità, differenziabilità e continuità
	% (Diff(A) = D(A) \cap C(A)).
	% Da includere con \input{Analisi2/figures/insieme-di-funzioni_tikz.tex}
	...
	\begin{tikzpicture}[
		...
		% ---- le due ellissi ----
		\draw (-3.2,0) ellipse (5.0 and 2.3);
		\draw (3.2,0)  ellipse (5.0 and 2.3);
		
		% ---- etichette ----
		\node at (-5.0,0) {$D(A)$};
		\node at (5.0,0)  {$C(A)$};
		\node at (0,0)    {$\operatorname{Diff}(A)$};
...
\begin{theorem}[Regola della catena]\footnote{Slide 3 PDF 18.}
	...
	\end{equation*}
	e sia $f:A\rightarrow\mathbb{R}$ una funzione derivabile e differenziabile in $\uline x_0$, allora è possibile definire la funzione composta
	\begin{equation*}
		\begin{aligned}
...
\begin{proof}[Dimostrazione (caso $n=2$)]
	...
	\begin{figure}[ht]
		\centering
		%\includegraphics[width=0.45\textwidth]{Analisi2/figures/dimostrazione_schwarz.png}
			...
			\begin{tikzpicture}[
				...
				% ---- etichette dei punti ----
				\node[anchor=south west, xshift=1.5pt, yshift=0.5pt] at (\xzero,\yzero) {$P_0$};
				\node[anchor=south west, xshift=1.5pt, yshift=0.5pt] at (\xbig,\ybig) {$P$};
				
				% ---- etichetta dell'insieme aperto (fuori dal bordo) ----
				\node at (7.75,5.95) {$A$};
				
			\end{tikzpicture}
		\caption{Rappresentazione nel piano dei punti di interesse.}\label{fig:dimostrazione_schwarz}
	\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.65\textwidth]{Analisi2/figures/segmento.jpeg}
	\caption{Rappresentazione nel piano cartesiano di un segmento (ovvero in $\mathbb{R}^2$).}\label{fig:segmento}
\end{figure}
...
\begin{example}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.5\textwidth]{Analisi2/figures/x-pow-3.jpg}
		\caption{Grafico di $f(x)=x^3$.}\label{fig:x-pow-3}
	\end{figure}
\end{example}
...
\begin{proof}
	...
	\begin{equation}\label{eq:derivata_direzionale_0_fermat}
		F'(0) = \underbrace{<\triangledown f(\uline x_0),\uline v> = 0}_{\footnotemark},\quad\forall\uline v\in\mathbb{R}^n,\; ||\uline v|| = 1,
	\end{equation}
...
\end{equation*}
riducendo così il problema ad una variabile (un esempio di parametrizzazione è l'Esempio \ref{ex:parametrizzazione_funzione_vincolo}). Il problema ad una variabile è studiato come in Analisi 1.
...
\paragraph{Passi per risolvere esercizio di ottimizzazione vincolata:}
\begin{enumerate}
	\item Disegnare il vincolo ed in base a quello capire i valori massimi di $x$ e $y$;
	\item Ricercare i punti critici all'interno del dominio come per l'ottimizzazione libera (gradiente = 0 e test hessiana), scartando i punti che non sono nel dominio;
	\item Studiare il vincolo esprimendo la $x$ in funzione della $y$ o tenendo fissa $x$ o $y$ in base alla struttura del vincolo. In questo caso lo studio di funzione sarà uguale a quello di Analisi 1, la funzione ristretta al vincolo $f_{D_n}$ sarà di una variabile, quindi
	\begin{enumerate}
		\item se (ad occhio) $f$ (in $x$ o $y$) è crescente o descrente allora gli estremi della variabile $x$ o $y$ determinano i punti di massimo e minimo;
		\item altrimenti è necessario studiare il segno della derivata $f'_{D_n}$ (ovvero per quali $x$ o $y$ $f'_{D_n}\geq 0$).
	\end{enumerate}
\end{enumerate}

\paragraph{Esempio del punto 3.:} Vedere Esempio \ref{ex:ottimizzazione_vincolata} ed Esempio \ref{ex:ottimizzazione_vincolata_1}.
...
\begin{example}[Ricerca massimi e minimi vincolati]\label{ex:ottimizzazione_vincolata}\footnote{Adobe Scan 13 lug 2024.}
	\paragraph{Testo:} Determinare, se esistono i punti di minimo e massimo vincolato associati alla funzione
	\begin{equation*}
		f(x,y) = 8-3x^4-6y^2-3xy,
	\end{equation*}
	nel dominio $D=\{(x,y)\in\mathbb{R}^2\;|\; -1\leq x\leq 0,\; -1\leq y\leq x\}$ (vedere Figura \ref{fig:vincolo}).
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.5\textwidth]{Analisi2/figures/vincolo.jpg}
		\caption{Grafico di $D=\{(x,y)\in\mathbb{R}^2\;|\; -1\leq x\leq 0,\; -1\leq y\leq x\}$.}\label{fig:vincolo}
	\end{figure}
	
	\paragraph{Svolgimento:} La funzione $f(x,y)$ è continua in $D$, quindi, per il Teorema \ref{th:weierstrass_2} di Weierstrass, ha minimo e massimo assoluti in $D$.
	Cerchiamo i punti critici, overro la soluzione di
	\begin{equation*}
		\triangledown f(x,y) = \left(\frac{\partial f}{\partial x}(x,y),\frac{\partial f}{\partial y}(x,y)\right) = (-12x^3 - 3y, -12y-3)=(0,0).
	\end{equation*}
	Quindi,
	\begin{equation*}
		\begin{cases}
	...
	\begin{itemize}
		\item [$\boldsymbol{D_1}$]
		\begin{equation*}
			f_{|_{D_1}} = f(x,-1)= f(x) = 8 -3x^4-6 + 3x = -3x^4 + 3x + 2,
		\end{equation*}
		con $x\in[-1,0]$. Dato che
		\begin{equation*}
			f'_{|_{D_1}} = -12 x^3 + 3 \leq 0,\quad\forall x\in[-1,0],
		\end{equation*}
		ovvero è crescente in $D_1$, allora i punti di minimo e massimo assoluto per $f_{|_{D_1}}$ sono
		\begin{equation*}
			\begin{matrix}
				f(-1,-1)&=&8-3-6-3 &=& -4,\\
				f(0,-1) &=& 8-6 &=& 2.
		...
		\item [$\boldsymbol{D_2}$] 
		\begin{equation*}
			f_{|_{D_2}}= f(0,y)= f(y) = 8 - 6y^2,
			\end{equation*}
			con $y\in[-1,0]$. Dato che
			\begin{equation*}
			f'_{|_{D_1}} = -12 y \leq 0,\quad\forall y\in[-1,0],
			\end{equation*}
			ovvero è crescente in $D_2$, allora i punti di minimo e massimo assoluto per $f_{|_{D_2}}$ sono $f(0,-1) = 2$ e $f(0,0)=8$.
		\item [$\boldsymbol{D_3}$] 
		\begin{equation*}
			f_{|_{D_3}}= f(x,x) =f(x)= 8 - 3x^4 - 6x^2 - 3x^2 = -3x^4 - 9x^2 + 8,
		\end{equation*}
		con $x\in[-1,0]$. Dato che
		\begin{equation*}
			f'_{|_{D_3}} = -12x^3 - 18x =  -6x(2x^2 + 3)\leq 0,\quad\forall x\in[-1,0],
		\end{equation*}
		ovvero è crescente in $D_3$, allora i punti di minimo e massimo assoluto per $f_{|_{D_3}}$ sono $f(-1,-1) = -4$ e $f(0,0)=8$.
	\end{itemize}
	Pertanto, $(-1,-1)$ è il punto di minimo assoluto  e $(0,0)$ punto di massimo assoluto di $f$ in $D$. 
\end{example}

\begin{example}\label{ex:ottimizzazione_vincolata_1}\footnote{Compito12gennaio2024.}
	\paragraph{Testo:} Determinare, se esistono, i punti di minimo e massimo assoluti della funzione
	\begin{equation*}
		f(x,y) = xye^{-xy}
	\end{equation*}
	sul dominio $D=\{(x,y)\in\mathbb{R}^2\,|\, 0\leq x, 1\leq y\leq2,|xy|\leq 1\}$ (vedere Figura \ref{fig:vincolo_3}).
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.5\textwidth]{Analisi2/figures/vincolo_3}
		\caption{Grafico di $D=\{(x,y)\in\mathbb{R}^2\,|\, 0\leq x, 1\leq y\leq2,|xy|\leq 1\}$.}
		\label{fig:vincolo_3}
	\end{figure}
	\paragraph{Svolgimento 1:} Osserviamo che $f(x,y)$ è continua sul dominio limitato e chiuso $D$ e dunque per il Teorema di Weierstrass ammette il massimo e minimo assoluto su $D$. Inoltre, $f(x,y)$ è una funzione di $t=xy$, ovvero
	\begin{equation*}
	...
	\paragraph{Svolgimento 2:} Poiché
	\begin{equation*}
		\triangledown f(x,y) = (ye^{-xy}(1-xy), xe^{-xy}(1-xy)),
	\end{equation*}
	\begin{equation*}
		\triangledown f(x,y) = (0,0) \iff
		\begin{cases}
			(x,y)=(0,0)\\
			xy=1
		\end{cases}
	...
	\begin{itemize}
		\item $D_1=\partial D\cup\{x=0\}$, dove $f_{|_{D_1}}=0$,
		\item $D_2=\partial D\cup\{y=1\}$, dove $f_{|_{D_2}}=f(x,1)=xe^{-x}$,
		\item $D_3=\partial D\cup\{xy=1\}$, dove $f_{|_{D_3}}=f(x,\frac{1}{x})=e^{-1}$,
		\item $D_4=\partial D\cup\{y=2\}$, dove $f_{|_{D_4}}=2xe^{-2x}$.
	\end{itemize}
	Da tali insiemi sono ottenuti massimi e minimi assoluti precedenti.
\end{example}

\begin{example}[Ricerca massimi e minimi vincolati]\label{ex:applicazione_metodo_lagrange}\footnote{Scritto 15 Settembre 2025.}
	\paragraph{Testo:} Determinare, se esistono i punti di minimo e massimo vincolato associati alla funzione
	\begin{equation*}
		f(x,y) = 1+x^2-y^2,
	\end{equation*}
	condizionati al vincolo $2x^2+y^2=2$ (vedere Figura \ref{fig:vincolo_2}).
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.5\textwidth]{Analisi2/figures/condizione_scritto_15_settembre}
		\caption{Grafico di $2x^2+y^2=2$.}
		\label{fig:vincolo_2}
	\end{figure}
	\paragraph{Svolgimento:} Sia $D=D_1\cup D_2$, dove 
	\begin{equation*}
		D_1:
		\begin{cases}
			x=t,\\
			y= \sqrt{2-2t^2},\quad t\in[-1,1]
		\end{cases}
	\end{equation*}
	e 
	\begin{equation*}
	...
	\begin{itemize}
		\item [$\boldsymbol{D_1}$:] 
		\begin{equation*}
			f_{|_{D_1}} = f(x, \sqrt{2-2x^2}) = 1+ x^2 - (\sqrt{2-2x^2})^2 = 1+x^2-2+2x^2=3x^2-1,
		\end{equation*}
		quindi dallo studio del segno di $f'_{|_{D_1}}$ ($f'_{|_{D_1}} = 6x\geq0$? Vedere Figura \ref{fig:f'_vincolata>0}) è ottenuto che $(0,\sqrt{2})$ minimo assoluto $f_{|_{D_1}}$ in $[-1,1]$ e $(\pm 1, 1)\notin D$.
		\begin{figure}[ht]
			\centering
			%\includegraphics[width=0.35\textwidth]{Analisi2/figures/segno_derivata.jpg}
			\begin{tikzpicture}[
				x=2.2cm,
				y=1.035cm,
				line cap=round,
				...
				% Asse e separatori dei punti notevoli
				\draw[very thick,->] (-1.75,0) -- (1.75,0) node[right] {$x$};
				\draw[very thick] (-1.4,-0.75) -- (-1.4,2.25);
				\draw[very thick] ( 1.4,-0.75) -- ( 1.4,2.25);
				
				% Livello della tabella del segno
				\draw[very thick] (-1.4,0.75) -- (0,0.75);
				\draw[very thick,dashed] (0,0.75) -- (1.4,0.75);
				\draw[very thick] (0,0.75) -- (0,0);
				
				% Valori notevoli
				\node[below=2pt, xshift=12pt] at (-1.4,0) {$-\sqrt{2}$};
				\node[below=4pt] at (0,0) {$0$};
				\node[below=2pt, xshift=-12pt] at (1.4,0) {$\sqrt{2}$};
				
				% Segno della derivata
				\draw[very thick,->] (-0.95,1.2) -- (-0.35,1.85);
				\draw[very thick,->] (0.35,1.85) -- (0.95,1.2);
			\end{tikzpicture}
			\caption{Segno $f_{|D1}'$.}\label{fig:f'_vincolata>0}
		\end{figure}
		
		\item [$\boldsymbol{D_2}$:] 
		\begin{equation*}
			f_{|_{D_2}}=f\left(\sqrt{\frac{2-y^2}{2}}, y\right) = 1+ \left(\sqrt{\frac{2-y^2}{2}}\right)^2 - y^2 = 1 + \sqrt{\frac{2-y^2}{2}} -y^2 = 2-\frac{3}{2} y^2,
		\end{equation*}
		quindi dallo studio del segno di $f'_{|_{D_2}}$ ($f'_{|_{D_2}} = -3y^2\geq0$? Vedere Figura \ref{fig:f'_vincolata_1>0}) è ottenuto che $(1,0)$ è il massimo assoluto di $f_{|_{D_2}}$ in $[-\sqrt{2}, \sqrt{2}]$ e $(1, \pm\sqrt{2})\notin D$ .
		\begin{figure}[ht!]
			\centering
			%\includegraphics[width=0.35\textwidth]{Analisi2/figures/segno_derivata_1.jpg}
			\begin{tikzpicture}[
				x=2.2cm,
				y=1.035cm,
				line cap=round,
				...
				% Livello della tabella del segno
				\draw[very thick,dashed] (-1.4,0.75) -- (0,0.75);
				\draw[very thick] (0,0.75) -- (1.75,0.75);
				\draw[very thick] (0,0.75) -- (0,0);
				
				% Valori notevoli, spostati per non sovrapporsi ai separatori
				\node[below=6pt, xshift=12pt] at (-1.4,0) {$-1$};
				\node[below=4pt] at (0,0) {$0$};
				\node[below=6pt, xshift=-12pt] at (1.4,0) {$1$};
				
				% Segno della derivata
				\draw[very thick,->] (-0.95,1.85) -- (-0.35,1.2);
				\draw[very thick,->] (0.35,1.2) -- (0.95,1.85);
			\end{tikzpicture}
			\caption{Segno $f_{|D2}'$.}
			\label{fig:f'_vincolata_1>0}
		\end{figure}
	\end{itemize}
	...
	\paragraph{Svolgimento con Lagrange:} Per trovare i punti di massimo e minimo utilizzo il metodo dei moltiplicatori di Lagrange.\\
	...
	\begin{equation*}
		\triangledown g(x,y) = (4x,4y) \Rightarrow \triangledown g(x,y) = (0,0) \iff x - y = 0 \notin V. \; (\text{condizione soddisfatta})
	\end{equation*}
	Per trovare i punti di massimo e minimo cerco i punti critici della funzione Lagrangiana:
	\begin{equation*}
		L(x,y,\lambda) = f(x,y) - \lambda[g(x,y)-k]\quad\text{tale che}\quad\triangledown L(x,y,\lambda) = (0,0,0),
	\end{equation*}
...
%		\end{cases}
	...
	Dall'ultimo sistema
	\begin{enumerate}
		\item se $\lambda = \frac{1}{2}$ allora sostituendola nella seconda e terza equazione è ottenuto $y=0$ e $x = \pm 1$,
		\item se $x=0$ allora sostituendola nella terza equazione è ottenuto $y=\pm\sqrt{2}$.
	\end{enumerate}
...
\paragraph{Relazione tra la Lagrangiana (\ref{eq:lagrangiana}) e Teorema \ref{th:moltiplicatori_lagrange} dei moltiplicatori di Lagrange?} Tale relazione è dovuta all'equivalenza delle soluzioni di \ref{eq:sistema_lagrangiana_0} e (\ref{eq:identita_vettoriale_moltiplicatore_lagrange}), ovvero: se $(x_0,y_0,\lambda_0)$ è punto stazionario di $L$ allora è soluzione di \ref{eq:sistema_lagrangiana_0} ($L(x_0,y_0,\lambda_0) =\uline 0$) e di (\ref{eq:identita_vettoriale_moltiplicatore_lagrange}).
...
\paragraph{Perché si chiama Teorema \ref{th:moltiplicatori_lagrange} dei moltiplicatori di Lagrange? Perché definisce il metodo dei moltiplicatori di Lagrange:} per funzioni ad $n$ variabili ci possono essere fino ad $m <n$ vincoli, quindi $m$ moltiplicatori (i quali formeranno un vettore di $m$ componenti reali), quindi il sistema $\triangledown L(\uline x, \uline \lambda)=\uline{0}$ avrà $n+m$ equazioni in quanto $L$ è una funzione di $n+m$ variabili. 

\paragraph{Da ricordare:} Il metodo dei moltiplicatori di Lagrange fornisce i candidati, poi è necessario utilizzare il confronto diretto per stabilire se i punti sono di minimo o di massimo. Questo perché i punti sono estremi vincolati e vale l'equazione del vincolo.

\paragraph{Esempio di applicazione del Metodo di Lagrange:} Vedere Esempio \ref{ex:applicazione_metodo_lagrange}.

\begin{example}[Esempio di applicazione del Meteodo di Lagrange]
	\footnote{Slide 5-8 PDF 24.}
	\paragraph{Testo:} Determinare il minimo e massimo assoluti della funzione
	\begin{equation*}
		f(x,y) = (x-1)^2 - y^2,
	\end{equation*}
	soggetta al vincolo $V=\{(x,y)\in\mathbb{R}^2;\, x^2+y^2 = 1\}\subset\mathbb{R}^2$.
	\paragraph{Svolgimento:} $V$ è limitato e chiuso in $\mathbb{R}^2$ (vedere Figura \ref{fig:vincolo_metodo_lagrange}), quindi $V$ è un compatto. Essendo $f$ continua su $V$ allora esistono massimo e minimo vincolati su $V$, per il Teorema \ref{th:weierstrass_2} di Weierstrass.\\
	\begin{figure}[ht]
		\centering
		%\includegraphics[width=0.5\textwidth]{Analisi2/figures/vincolo_metodo_lagrange.jpg}
		\begin{tikzpicture}[
			x=2cm,
			y=2cm,
			line cap=round,
			...
			% Assi cartesiani
			\draw[thick,->] (-1.65,0) -- (1.75,0) node[right] {$x$};
			\draw[thick,->] (0,-1.35) -- (0,1.55) node[above] {$y$};
			
			% Vincolo circolare V
			\draw[very thick] (0,0) circle[radius=1.15];
			\node[font=\large] at (-0.78,1.12) {$V$};
			
			% Retta x=1/2 e punti di intersezione con il vincolo
			\pgfmathsetmacro{\xhalf}{0.575}
			\pgfmathsetmacro{\yhalf}{sqrt(1.15^2-\xhalf^2)}
			\draw[very thick] (\xhalf,-\yhalf) -- (\xhalf,\yhalf);
			\node[above right=2pt] at (\xhalf,0) {$\frac{1}{2}$};
			
			% Estremi evidenziati
			\fill[red] (-1.15,0) circle[radius=2.2pt];
			\fill[red] (\xhalf, \yhalf) circle[radius=2.2pt];
			\fill[red] (\xhalf,-\yhalf) circle[radius=2.2pt];
			
			\node[red,align=center,left=2pt] at (-1.15,0)
			{\textbf{Max}\\[2pt]$(-1,0)$};
			
			% Indicazione dei punti di minimo
			\draw[red,very thick,->]
			(\xhalf,\yhalf) -- (1.75,0.35);
			\draw[red,very thick,->]
			(\xhalf,-\yhalf) -- (1.75,-0.32);
			\node[red,font=\large\bfseries,right=9pt] at (1.75,0) {Min};
		\end{tikzpicture}
		\caption{Grafico di $x^2+y^2=1$ con massimo assoluto $(-1,0)$ e minimi assoluti $\left(\frac{1}{2}, \pm\frac{\sqrt{3}}{2}\right)$.}
		\label{fig:vincolo_metodo_lagrange}
	\end{figure}
	\paragraph{Come trovare massimo e minimo vincolati?} Dato il vincolo, è noto che $y^2 = 1 - x^2$ e quindi, sostituendola in $f$, la funzione diventa ad una sola variabile. Il problema è ridotto allo studio di una funzione di una variabile. $\qed$\\
	...
	\begin{equation*}
		f_{|_V} = (x-1)^2 - (1-x^2) = 2x^2 - 2x,\quad x\in[-1,1].
	\end{equation*}
	È necessario studiare il segno della derivata di $f_{|_V}$ essendo una funzione ad una variabile, quindi
	\begin{equation*}
		f'_{|_V} = (2x^2 - 2x)' = 4x - 2 = 2(2x - 1).
	\end{equation*}
	Pertanto,
	\begin{equation*}
		f'(x) = 0\quad\iff\quad x = \frac{1}{2},
	\end{equation*}
	quindi $x=\frac{1}{2}$ è minimo assoluto per $f_{|_V}$. Inoltre, è possibile osservare che sostituendo $x$ in $V$ è ottenuto che
	\begin{equation*}
		y^2 = 1 - \frac{1}{4} = \frac{3}{4}\quad\equiv\quad y = \pm\frac{\sqrt{3}}{2},
	\end{equation*}
	e quindi $\left(\frac{1}{2}, -\frac{\sqrt{3}}{2}\right)$ e $\left(\frac{1}{2}, \frac{\sqrt{3}}{2}\right)$ sono i punti di minimo assoluto in quanto $f\left(\frac{1}{2}, -\frac{\sqrt{3}}{2}\right) = -\frac{1}{2}$ è il valore più piccolo che la funzione può assumere.\\
	\paragraph{Cosa accade per gli altri punti?} Per $x=\pm 1$ allora $y^2 = 1 - 1 = 0$, quindi $(-1,0),\, (1, 0)$. Per stabilire il massimo assoluto è necessario svolgere un confronto diretto sui punti trovati tramite $f$:
	\begin{equation*}
		\begin{matrix}
			f(-1, 0) &=& 4 && \\
			&&&\Rightarrow& (-1,0)\text{ punto di massimo assoluto vincolato.}\\
			f(1,0) &=& 0 &&
		\end{matrix}
	\end{equation*}
	\paragraph{Svolgimento con Lagrange:} È necessario verificare la regolarità rispetto al vincolo, quindi sono ricercati i punti dove il gradiente di $g$ si annulla e stabilito se questi appartengono al vincolo per verificare la regolarità di $g$ nei punti. Quindi, vale quanto segue:
	\begin{equation*}
		\triangledown g(x,y) = (2x, 2y) = \uline 0\quad \iff \quad (x,y) = (0,0),
	\end{equation*}
	...
	\end{equation*}
	allora
	\begin{equation}\label{eq:esempio_sistema_lagrange}
		\triangledown L(x,y,\lambda) = (0,0,0) \iff
		\begin{cases}
			2(x-1) - 2\lambda x &= 0\\
			-2y - 2\lambda y &= 0\\
			-[x^2+y^2-1]&=0
		...
		\end{cases}
	\end{equation}
	\paragraph{Nota:} È necessario risolvere il sistema (\ref{eq:esempio_sistema_lagrange}), dove le soluzioni sono terne. $\qed$\\
	Dalla seconda equazione del sistema (\ref{eq:esempio_sistema_lagrange}) sono ottenute $\lambda = -1$ e $y=0$ e quindi i seguenti due sistemi
	\begin{equation*}
		\underbrace{\begin{cases}
			\footnotemark\; y &= 0 \\
			\footnotemark\; x^2 &= 1\\
			\footnotemark\; \lambda &= \frac{x-1}{x}
		\end{cases}}_{I} \quad\cup\quad
		\underbrace{\begin{cases}
			\lambda &= -1\\
			2(x-1) + 2x &= 0\\
			x^2 + y^2 &= 1
...
\end{example}
\addtocounter{footnote}{-2}
\footnotetext{Seconda equazione del sistema (\ref{eq:esempio_sistema_lagrange}).}

\stepcounter{footnote}
\footnotetext{Terza equazione del sistema (\ref{eq:esempio_sistema_lagrange}).}

\stepcounter{footnote}
\footnotetext{Prima equazione del sistema (\ref{eq:esempio_sistema_lagrange}).}

\paragraph{Perché due sistemi ($I$ e $II$)?} Perche dalla seconda equazione del sistema (\ref{eq:sistema_moltiplicatore_lagrange}) è ottenuto che è 0 in due casi, quindi sono ottenuri due sistemi.
...
\begin{equation*}
	...
	\end{cases}
\end{equation*}
ovvero $\boldsymbol{\underline{(-1, 0}, 2)}$ e $\boldsymbol{\underline{(1,0},0)}$.\\
...
\begin{equation*}
	...
	\end{cases}
\end{equation*}
ovvero $\boldsymbol{\left(\underline{\frac{1}{2}, -\frac{\sqrt{3}}{2}}, -1\right)}$ e $\boldsymbol{\left(\underline{\frac{1}{2}, \frac{\sqrt{3}}{2}}, -1\right)}$.

\paragraph{Nota:} I punti sottolineati sono i candidati ad essere punti di minimo / massimo, pertanto è necessario un controllo diretto per stabilire quale sia il massimo e minimo assoluto. $\qed$

Siano
\begin{equation*}
	f(1,0) = 0, \quad f(-1,0) = 4,\quad f\left(\frac{1}{2},\pm\frac{\sqrt{3}}{2}\right) = \frac{1}{2},
\end{equation*}
per confronto diretto $(-1, 0)$ è il massimo assoluto vincolato e $\left(\frac{1}{2},\pm\frac{\sqrt{3}}{2}\right)$ i due minimi assoluti vincolati.

\begin{example}[Esempio applicazione del metodo dei Moltiplicatori di Lagrange]\footnote{Slide 9-11 PDF 24.}
	\paragraph{Testo:} Determinare i punti di massimo e minimo assoluti per la funzione
	\begin{equation*}
		f(x,y) = x\, e^{-(x^2+y^2)},
	\end{equation*}
	soggetta al vincolo $V=\{(x,y)\in\mathbb{R}^2;\, g(x,y) = 0\}\subseteq\mathbb{R}^2$, dove $g(x,y) = x^2 + (y-1)^2 - 1$.
	
	\paragraph{Nota:} $g(x,y)$ è una forma quadratica. $\qed$
	
	$V$ è una circonferenza di centro $C(0,1)$ e raggio $r=1$.
	
	\paragraph{Svolgimento:} È possibile parametrizzare il vincolo attraverso la seguente relazione:
	\begin{equation*}
		\begin{cases}
			x &= \cos\theta\\
			y-1 &= \sin\theta 
	...
	Quindi $f_{|_V} = f(\theta)$ e $V=\gamma ([0,2\pi])$ (il vincolo è il sostegno della curva $\gamma$), ovvero
	\begin{equation*}
		f_{|_V} = f(\gamma([0,2\pi])) = f(\theta) = \cos\theta e^{-(\cos^2\theta + 1 + 2\sin\theta + \sin^2\theta)} \overset{\sin^2\theta+\cos^2\theta = 1}{=} \cos\theta e^{-2(1+\sin\theta)}.
	\end{equation*}
	Per trovare i punti critici è studiata la derivata prima di $f_{|_V}$ con i mezzi di Analisi 1:
	\begin{equation*}
		f'(\theta) = \underbrace{e^{-2(1+\sin\theta)}}_{>0} (-\sin\theta - 2\cos^2\theta).
	\end{equation*}
	\begin{equation*}
		f'(\theta) = 0 \iff -\sin\theta - 2\cos^2\theta = 0 \rightarrow -\sin\theta - 2(1-\sin^2\theta) = 0 \rightarrow 2\sin^2\theta - \sin\theta - 2 \overset{\sin\theta = t}{\longrightarrow} 2 t^2 - t - 2 = 0, 
	\end{equation*}
	quindi le soluzioni sono $t_{1,2} = \frac{1 \pm \sqrt{1+ 16}}{4}$.
	
	\paragraph{Nota:}  $t_{1,2}$ le due soluzioni corrispondono a quelle di $\sin\theta$, ovvero $y-1$. Quindi, trovando le soluzioni è trovata $y$ e di conseguenza la $x$, dove la $x$ è ricavata dall'equazione $1-\sin^2\theta = \cos^2\theta\rightarrow\sqrt{1-\sin^2\theta} = \cos\theta$. $\qed$
	
	\paragraph{Nota:} Studiando il segno di $f'(\theta)$, trovando i candidati e le coordinate dei punti, ricordandosi che $t_1 = \sin\theta_1 \equiv y-1$, dove $y_1 = 1 + t_1 \equiv y$ e $x\equiv\cos\theta_1$ dove $x \equiv x_1 = \pm\sqrt{1-\sin^2\theta}$.
	
	\paragraph{Svolgimento tramite metodo dei moltiplicatori di Lagrange:} Sia
	\begin{equation*}
		\triangledown g(x,y) = (2x,2(y-1)),
	\end{equation*}
	\begin{equation*}
		\triangledown g(x,y) = 0 \iff (x,y) = (0,1)\notin V.
	\end{equation*}
	Considerata la Lagrangiana
	\begin{equation*}
 	...
 	\begin{equation}\label{eq:sistema_moltiplicatori_lagrange_1}
 		\triangledown L(x,y,\lambda) = (0,0,0) \iff
 		\begin{cases}
 			L_x (x,y,\lambda) = e^{-(x^2+y^2)} - 2x^2\, e^{-(x^2+y^2)} - 2\lambda x=0\\
 			L_y (x,y,\lambda) = -2xy\, e^{-(x^2+y^2)} - 2\lambda (y-1) = 0\\
 			L_\lambda (x,y,\lambda) = x^2 + (y-1)^2 -1 = 0
 		\end{cases}
 	\end{equation}
 	
 	\paragraph{Nota:} Il sistema (\ref{eq:sistema_moltiplicatori_lagrange_1}) è complesso, allora è possibile semplificare il calcolo della soluzione cercando di combinare le equazioni del sistema. In questo modo è possibile trovare una soluzione combinando le prime due equazioni del sistema e raccogliendo l'esponenziale come nel sistema (\ref{eq:sistema_moltiplicatori_lagrange_2}). $\qed$
 	
 	\begin{equation}\label{eq:sistema_moltiplicatori_lagrange_2}
 		\begin{cases}
 			e^{-(x^2+y^2)} [1-2x^2] = 2\lambda x\\
 		e^{-(x^2+y^2)}(-2xy) = 2 \lambda (y-1)\\
 		x^2 + (y-1)^2 - 1 =0
 		\end{cases}
 	\end{equation}
 	quindi
 	\begin{equation*}
 		\frac{2x^2 - 1}{2xy} = \frac{x}{y-1} \iff (2x^2 - 1)(y-1) = 2x^2y \quad\rightarrow\quad 2x^2y - y + 1 - 2x^2 = 2x^2y \quad\rightarrow\quad\underbrace{y = 1-2x^2}_{(b)}
 	\end{equation*}
 	e sostituendo $(b)$ nell'ultima equazione del sistema (\ref{eq:sistema_moltiplicatori_lagrange_2}) è ottenuto
 	\begin{equation*}
 		x^2 + 4x^4 - 1 = 0 \quad\rightarrow\quad x^2 = \frac{-1 \pm \sqrt{17}}{8} \quad\overset{\boldsymbol{\footnotemark}}{\rightarrow}\quad \frac{-1 + \sqrt{17}}{8}.
 	\end{equation*}
 	\footnotetext{Scartata opzione con il $-$ perché $x^2>0$.}
 	Quindi
 	\begin{equation*}
 		x = \sqrt{\frac{-1 + \sqrt{17}}{8}}\quad\text{e}\quad y = 1 - 2\left(\frac{-1 + \sqrt{17}}{2}\right) = \frac{5 - \sqrt{17}}{4}.
 	\end{equation*}
 	...
 	\paragraph{Nota:} $P_1$ e $P_2$ sono determinati dal fatto che $e^{-(x^2+y^2)}>0$ e quindi il segno di $f$ è determinata da $x$.
\end{example}
