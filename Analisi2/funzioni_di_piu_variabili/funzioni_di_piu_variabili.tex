...
\begin{definition}[Funzione derivabile]\footnote{Slide 10 PDF 15.}
	...
	\begin{equation*}
		...
		\end{aligned}
	\end{equation*}
	Se $f$ è derivabile in $A$ allora $\exists\frac{\partial f}{\partial x_i}(\uline x)\, \forall\uline x\in A,\, i=1,\hdots, n$, dove $\frac{\partial f}{\partial x_i}(\uline x)$ è (se esiste finito) $\lim_{h\rightarrow 0}\frac{f(x_1,\hdots,x_i+h,\hdots,x_n)-f(\uline x)}{h}$.
...
\begin{definition}[Curva in $\mathbb{R}^n$]\footnote{Slide 5 PDF 15.}
	Una curva è un'applucazione continua ($\varphi\in C^0(I)$) definita come
	\begin{equation}\label{eq:curva}
		\begin{aligned}
			f\colon I=[a,b]\subset\mathbb R & \rightarrow \mathbb R^n\\
...
\begin{definition}[Sostegno di una curva]\footnote{Slide 6 PDF 15.}
...
\begin{definition}[Derivata direzionale]\label{def:derivate_direzionali_Rn}\footnote{Slide 11 PDF 15.}
...
\begin{definition}[Derivata Direzionale]\footnote{Slide 12 PDF 15.}
...
\begin{theorem}[del differenziale]\label{th:del_differenziale}\footnote{Slide 9 PDF 17}
	Sia $f:A\subseteq\mathbb{R}^n\rightarrow\mathbb{R}$, con $A$ aperto. (HP) Sia $f$ differenziabile in $A$ (ovvero $\exists\triangledown f(\uline x),\, \forall\uline x\in A$). Se le derivate parziali $f_{x_1}(\uline x),\hdots, f_{x_n}(\uline x)$, sono continue in $\uline x$ allora $f$ è differenziabile in $\uline x\in A$.
\end{theorem}
...
\begin{theorem}\footnote{Slide 5 PDF 18.}
	Sia
	\begin{equation*}
		\begin{aligned}
			\gamma:I\subseteq\mathbb{R}&\rightarrow\mathbb{R}^n\\
