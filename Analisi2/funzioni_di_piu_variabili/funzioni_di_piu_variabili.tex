...
\begin{definition}[Funzione continua]\footnote{Slide 2 PDF 10.}
...
\begin{remark}[Non ufficiale]\footnote{Slide 14 PDF 10.}
    Le coordinate polari definite come (\ref{eq:coordinate_polari_piano}) sono centrate in $(0,0)$. Le coordinate polari potrebbero essere traslate e centrate nel punto $(x_0,y_0)\neq(0,0)$, come in Figura \ref{fig:piano_coordinate_polari_centrate_x0_y0}. E' possibile generalizzare il caso (\ref{eq:coordinate_polari_piano}) come segue: Nel caso in cui il sistema di riferimento sia centrato in $(x_0,y_0)$ allora il punto $(x,y)$ puo' essere trasformato in coordinate polari attraverso le seguenti
    \begin{equation*}
        \begin{cases}
            x=x_0+\rho\cos\theta,\\
            y=y_0+\rho\sin\theta.
