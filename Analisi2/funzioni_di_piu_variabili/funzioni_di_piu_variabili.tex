...
\paragraph{Cosa afferma il Teorema di Schwarz:} Il Teorema afferma che se $f\in C^2(A)$ allora le derivate miste sono uguali $\forall \uline x\in A$. Inoltre, il Teorema si può generalizzare anche con $f\in C^k(A)$ facendo si che valga per tutte le derivate fino all'ordine $k$.
...
\begin{proof}[Dimostrazione (caso $n=2$)]
	...
	Sia $P=(x,y)\in A$, con $P\neq P_0$ ($P$ punto qualsiasi, in questo caso scelto maggiore di $P_0$).
\end{proof}
