	...
	\begin{enumerate}
		...
		\begin{equation*}
			\begin{matrix}
				...
				\end{vmatrix} &=& \lambda_1 e^{(\lambda_1+\lambda_2)x} - \lambda_2 e^{(\lambda_1+\lambda_2)x} &=& \underbrace{(\lambda_2 -\lambda_1)}_{\footnotemark} e^{(\lambda_1+\lambda_2)x} &\overset{\footnotemark}{\neq}& 0. 
			\end{matrix}
		\end{equation*}
		...
		\stepcounter{footnote}
		\footnotetext{Diverso da 0 perché $\Delta\neq 0$.}
...
quindi
\begin{equation*}
	\exists! \, (c_1'(x),c_2'(x)) \quad\text{soluzione}
\end{equation*}
