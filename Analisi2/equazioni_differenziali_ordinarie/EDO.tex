...
\paragraph{Come si risolve un problema di Cauchy per EDO lineari del primo ordine a coefficienti costanti?}
\begin{enumerate}
	...
	\item Determinare $c$ imponendo la condizione iniziale $y(x)=y_0$,
